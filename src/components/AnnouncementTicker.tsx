...
export function AnnouncementTicker() {
  ...
  return (
    <div className="relative overflow-hidden py-3 bg-gradient-to-r from-primary via-accent to-primary">
      ...
      <div className="relative flex items-center">
        ...
        <div className="animate-ticker whitespace-nowrap text-primary-foreground font-body text-sm font-semibold drop-shadow-sm group-hover:[animation-play-state:paused]">
