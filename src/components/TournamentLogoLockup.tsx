  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-3">
        ...
        <div className={`h-14 w-14 md:h-16 md:w-16 rounded-2xl bg-gradient-to-br ${branding.accentClass} text-primary-foreground flex items-center justify-center font-display text-xl md:text-2xl font-black shadow-soft`}>
          {branding.shortCode}
        </div>
      </div>
