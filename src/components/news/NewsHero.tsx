    ...
    <section className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-slate-900 via-indigo-900 to-blue-900 px-6 py-8 text-slate-50 shadow-lg md:px-10 md:py-10">
      ...
      <div className="relative space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <Badge className="gap-2 border border-primary-foreground/25 bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground/10">
            <Sparkles className="h-3.5 w-3.5" />
            Newsroom Pulse
          </Badge>
          <div className="flex flex-wrap items-center gap-2 text-xs text-blue-100/90 md:text-sm">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-primary-foreground/10 px-3 py-1">
        ...
        <div className="max-w-3xl space-y-2">
          <h1 className="font-display text-3xl font-extrabold leading-tight tracking-tight text-primary-foreground md:text-4xl">Club Newsroom</h1>
