...
export function RouteChangeIndicator() {
  ...
  return (
    <div
      className="pointer-events-none fixed inset-x-0 top-0 z-[100] flex flex-col items-center gap-2 pt-3"
      role="status"
      aria-live="polite"
    >
      <div className="h-1 w-full overflow-hidden bg-primary/10" aria-hidden="true">
