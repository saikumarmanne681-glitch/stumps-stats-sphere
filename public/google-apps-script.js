...
const TABS = {
  ...
  DOCUMENT_SECURITY_PROFILES: ["document_id","profile_json","updated_by","updated_at"],
  ...
  DEPARTMENT_MEMBERS: ["id","department_id","user_id","member_name","role","added_by","added_date"],
  DEPARTMENT_ACTIVITY: ["id","department_id","user_id","action_type","description","created_at"],
  DEPARTMENT_AUDIT_LOGS: ["id","department_id","user_id","action","target","timestamp"],
...
function getKeyColumn(tabName) {
  const map = {
    ...
    DOCUMENT_SECURITY_PROFILES: "document_id",
    ...
    DEPARTMENT_ACTIVITY: "id",
    DEPARTMENT_AUDIT_LOGS: "id",
    DEPARTMENT_NOTIFICATIONS: "id",
