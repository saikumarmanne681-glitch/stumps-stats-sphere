...
const TABS = {
  ...
  CERTIFICATES: ["id","type","tournament","season","match_id","recipient_type","recipient_id","recipient_name","template_id","status","created_by","created_at","details_json","performance_json","verification_code","certified_at","certified_by","approval_status","approvals_json","signatures_json","certificate_html","verification_url","verification_token","security_hash","tamper_evident_payload","delivery_status","render_provider","render_status","render_error","rendered_at","canva_template_id","canva_job_id","canva_export_url"],
